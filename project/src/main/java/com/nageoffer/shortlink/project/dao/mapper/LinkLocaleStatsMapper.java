...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
    ...
    @Insert("INSERT INTO t_link_locale_stats (full_short_url, gid, date, cnt, country, province, city, adcode, create_time, update_time, del_flag)" +
            ...
            "#{linkLocaleStats.country}, #{linkLocaleStats.province}, #{linkLocaleStats.city}, #{linkLocaleStats.adcode}," +
            "NOW(), NOW(), 0) ON DUPLICATE KEY UPDATE cnt = cnt + #{linkLocaleStats.cnt};")
    void insertShortLinkLocaleStats(@Param("linkLocaleStats") LinkLocaleStatsDO linkLocaleStatsDO);
    ...
    List<LinkLocaleStatsDO> listLocaleByShortLink(@Param("param") ShortLinkStatsReqDTO shortLinkStatsReqDTO);
}
