...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
    ...
    @Select("SELECT SUM(old_user) AS oldUserCnt, SUM(new_user) AS newUserCnt " +
            ...
            "    GROUP BY user" +
            ") AS user_counts;")
    HashMap<String, Object> findUvTypeCntByShortLink(@Param("param") ShortLinkStatsReqDTO shortLinkStatsReqDTO);
    ...
    LinkAccessStatsDO findPvUvUidStatsByShortLink(@Param("param") ShortLinkStatsReqDTO shortLinkStatsReqDTO);
}
