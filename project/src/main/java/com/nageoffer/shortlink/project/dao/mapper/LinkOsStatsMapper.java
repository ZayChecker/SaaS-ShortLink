...
public interface LinkOsStatsMapper extends BaseMapper<LinkOsStatsDO> {
    ...
    @Insert("INSERT INTO t_link_os_stats (full_short_url, gid, date, cnt, os, create_time, update_time, del_flag)" +
            ...
            "#{linkOsStats.os}," +
            "NOW(), NOW(), 0) ON DUPLICATE KEY UPDATE cnt = cnt + #{linkOsStats.cnt};")
    void insertShortLinkOsStats(@Param("linkOsStats") LinkOsStatsDO linkOsStatsDO);
    ...
    List<HashMap<String, Object>> listOsStatsByShortLink(@Param("param") ShortLinkStatsReqDTO shortLinkStatsReqDTO);
}
